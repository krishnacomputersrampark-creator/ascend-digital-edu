...
export const Route = createFileRoute("/student/notifications")({
  head: () => ({ meta: [{ title: "Notifications · Krishna Computer Center" }, { name: "robots", content: "noindex" }] }),
  component: () => (
    <SiteLayout>
      <PageHero eyebrow="Student Portal" title="Notifications" subtitle="This module will be available soon." />
      <section className="py-16">
        <div className="mx-auto max-w-2xl px-4 text-center">
          <div className="glass-card mx-auto rounded-3xl p-10 shadow-brand">
            <span className="mx-auto grid h-16 w-16 place-items-center rounded-2xl gradient-brand text-white shadow-brand"><Bell className="h-8 w-8" /></span>
            <h2 className="mt-5 text-2xl font-extrabold text-ink">Module Coming Soon</h2>
            <p className="mt-2 text-sm text-muted-foreground">Personalized alerts & notices will appear here.</p>
