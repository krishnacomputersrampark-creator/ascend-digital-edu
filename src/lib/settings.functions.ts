...
export const saveSettings = createServerFn({ method: "POST" })
  .middleware([requireSupabaseAuth])
  .inputValidator(z.object({ group: z.string(), key: z.string(), value: z.record(z.any()), label: z.string() }).parse)
  .handler(async ({ data, context }) => {
...
export const saveIntegration = createServerFn({ method: "POST" })
  .middleware([requireSupabaseAuth])
  .inputValidator(z.object({ provider: z.string(), category: z.string(), isEnabled: z.boolean(), config: z.record(z.any()), secretKeys: z.array(z.string()) }).parse)
  .handler(async ({ data, context }) => {
